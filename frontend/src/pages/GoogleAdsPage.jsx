...
export default function GoogleAdsPage({ days = 30, syncVersion = 0 }) {
  ...
  return (
    <div className="page" id="page-gads">
      <div className="ph">
        <div className="ph-title"><span style={{ color: "var(--gads)" }}>●</span> Google Ads</div>
      ...
      <div className="da-grid">
        ...
        <div className="da-card" data-accent="teal">
          <div className="da-label">Baseline avg/day</div>
          <div className="da-val" style={{ color: "var(--teal)" }}>{fmt(data.anomaly?.baseline_mean)}</div>
          <div className="da-sub">trailing window</div>
        </div>
        <div className="da-card" data-accent="pink">
          ...
          <div className="da-sub">{bestCampaign ? `ROAS ${bestCampaign.roas}× · ${fmt(bestCampaign.amount)}` : "—"}</div>
        </div>
      </div>
