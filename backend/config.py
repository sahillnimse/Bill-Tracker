...
class Microsoft365Config:
    ...
    standard_license_cost: float = _get_float("MS365_STANDARD_LICENSE_COST", 830.0)  # INR, Business Standard (paid yearly)
    premium_license_cost: float = _get_float("MS365_PREMIUM_LICENSE_COST", 1830.0)   # INR, Business Premium (paid yearly)
